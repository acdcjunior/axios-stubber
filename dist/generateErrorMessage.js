...
const stringSimilarity_1 = require("./utils/stringSimilarity");
function generateErrorMessage(method, url, data, stubs) {
...
function requestToColorDiff(baseRequest, otherRequest) {
 ...
 ${baseRequest.body ?
        `\x1b[37m body: \x1b[0m${colorDiff(baseRequest.body !== undefined ? JSON.stringify(baseRequest.body, null, '  ') : `<undefined>`, otherRequest.body !== undefined ? JSON.stringify(otherRequest.body || '', null, '  ') : `<undefined>`).replace(/(\r?\n)/g, '$1  ')}`
        : ''}
\x1b[0m`;
}
...
//# sourceMappingURL=generateErrorMessage.js.map